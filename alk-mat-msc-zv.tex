...
\begin{description}
	...
	\item[Wishart-eloszlás] Ilyen mátrix elemeinek együttes eloszlását $ \left( p,{} n,{}
		\mathbf{ C } \right) $ paraméterű (centrális) \emph{Wishart-eloszlásnak} nevezzük --
...
állítás]{BollaKramli}. Nem elfajult $ p $-dimenziós normális eloszlású minta mintaátlagának,
valamint empirikus kovarianciamátrix $ n $-szeresének eloszlása \cite[5. fejezet, 4. szakasz, 4.3.
tétel]{BollaKramli}.
