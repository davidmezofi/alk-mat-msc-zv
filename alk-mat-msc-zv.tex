...
\documentclass[DIV=15,appendixprefix,twoside]{scrreprt}
%
% Színes hivatkozásokhoz kommenteld ki az alábbi sort!
% Élő hivatkozások, indexek, PDF-ben, színesekhez: `colorlinks=true`
\usepackage[unicode,pdfborder={0 0 0},colorlinks=false]{hyperref}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
a karakterisztikus görbék mentén, megoldása a kezdeti érték problémának. Megoldás $ f \left( x - c \left( f \left( x \right) t  \right)  \right)$.
