...
\begin{align}
	u_{ tt } 	&= \Delta_{ \mathbf{ x } } u;\tag{\textsc{homogén}}\\
	u_{ tt } 	&= \Delta_{ \mathbf{ x } } u + f,\tag{\textsc{inhomogén}}
\end{align}
...
\begin{equation*}
	\begin{aligned}
		u_{ tt } \left(x,{} t \right) 	&= u_{ xx } \left( x,{} t \right) 	&
			\left( \left( x,{} t \right) \in \mathbb{ R } \times \left( 0,{} \infty \right)
			\right);\\
...
\begin{equation*}
	\begin{aligned}
		u_{ tt } - \Delta u 						&= 0 								&
			\left( \left( \mathbf{ x },{} t \right) \in \mathbb{ R }^{ d } \times \left( 0,{} \infty
			\right) \right);\\
