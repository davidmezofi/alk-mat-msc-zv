...
\mathbf{ U } $) nem minden esetben létezik, még akkor sem, ha a mátrix nem szinguláris. Viszont ha a
...
Ha az $ \mathbf{ A } $ mátrix nem szinguláris, akkor az $ \mathbf{ L } \mathbf{ U } $ felbontás
