...
pont \emph{attraktor}, ha stabil halmaza tartalmazza egy nyílt környezetét is,
\emph{repellor}, ha instabil halmaza tartalmazza egy nyílt környezetét is.
...
nemdeterminisztikus Turing-gép, ha van olyan tanúszalag tartalom amire \textsc{Elfogad} állapotba
...
\begin{description}
	...
	\item[Diophantosz (Hilbert X. problémája)] Az input egy egész együtthatós polinom, kérdés, van-e
		egész gyöke. \textsc{Diophantosz} nem eleme $\mathcal{D}$-nek.
...
ciklikus kódok. Ez a gyűrű főideálgyűrű, és minden ideál előáll egy alkalmas minimális fokszámú
...
metsző egyenes $ K $-ba eső részénék hosszának várható értéke $ \mean \left( \sigma \right)  = \pi
